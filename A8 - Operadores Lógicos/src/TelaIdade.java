...
public class TelaIdade extends javax.swing.JFrame {
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        anoAtual = ano.getYear() + 1900;
        idade = anoAtual - Integer.parseInt(this.txtAno.getText());
        
        this.lblIdade.setText(Integer.toString(idade));
        if(idade < 16){
            situacao = "Não vota";
        }else if(idade < 18 || idade > 70){
            situacao = "Opcional a votar";
        }else{
            situacao = "Obrigado a votar";
        }
